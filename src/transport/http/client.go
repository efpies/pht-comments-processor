...
func (c *Client) SendRequest(method string, uri string, body io.Reader, configure ...func(*http.Request)) (resp *string, status int, err error) {
...
func (c *Client) sendRequest(req *http.Request) (response *string, status int, err error) {
